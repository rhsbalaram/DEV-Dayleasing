...
public class PropertySlotsServiceImpl implements PropertySlotsService {
  ...
  /* (non-Javadoc)
   * @see com.dayLeasing.service.PropertySlotsService#addSlot(com.dayLeasing.service.dto.PropertyslotsDTO, java.lang.String)
   */
  @Override
  public PropertyslotsDTO addSlot(PropertyslotsDTO propertyslotsDTO, String areaID) {
    Propertyslots convertedToPropertyslots = PropertyslotsVTO.convertToPropertyslots(
        propertyslotsDTO, areaID);
     Propertyslots slot = propertySlotsDao.addSlots(convertedToPropertyslots);
  ...
  /* (non-Javadoc)
   * @see com.dayLeasing.service.PropertySlotsService#getSlots(java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.dayLeasing.service.PropertySlotsService#getSlot(java.lang.String, java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.dayLeasing.service.PropertySlotsService#updateSlots(com.dayLeasing.service.dto.PropertyslotsDTO, java.lang.String, java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see com.dayLeasing.service.PropertySlotsService#deleteSlots(java.lang.String, java.lang.String)
   */
  @Override
